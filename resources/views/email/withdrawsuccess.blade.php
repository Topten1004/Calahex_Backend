...
<body>
    <div width="600"
        ...
        <div class="vertical-center" width="100%">
            <h1 style="font-size: 3vw"><strong>Withdrawal successful</strong></h1>
            <h2 style="font-size: 2vw">
                {{"You have succesfully withdrawed ".$details['amount']." ".$details['token']." from your Calahex account. If you do
                not recognize
